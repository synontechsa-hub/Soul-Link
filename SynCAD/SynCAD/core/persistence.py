...
def load_zad_file(filepath: str) -> Job:
    """Import a legacy Z-CAD .ZAD file into a SynCAD Job."""
...
def get_recent_jobs(jobs_dir: str = None, max_count: int = 10) -> list[dict]:
    """Return list of recent .zcad files sorted by modification time."""
