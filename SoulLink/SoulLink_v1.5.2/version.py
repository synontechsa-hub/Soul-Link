...
CODENAME: Final[str] = "Legion"
TAGLINE: Final[str] = "Does this unit have a soul?"
...
CODENAMES = {
    ...
    "1.5.1": "Reforged",
    "1.5.2": "Architect"
    # 1.5.3: Phoenix - From the ashes of my 1.5.2 disaster ofc... Fittinng
    # Only once im further along with recovery from my poopoo oopsie dumb-dumb...
}
...
VERSION_DISPLAY: Final[str] = f"{APP_NAME} v{VERSION_FULL} ({CODENAMES.get(f'{MAJOR}.{MINOR}', 'Architect')})"
...
BUILD_TIMESTAMP: Final[str] = datetime.utcnow().isoformat(timespec="seconds") + "Z"
...
# Similar to the basic flat style of c.ai/emochi but with more logic behind them
