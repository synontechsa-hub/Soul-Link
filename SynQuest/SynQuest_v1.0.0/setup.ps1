# SynQuest v1.0.0 — Bootstrap Setup Script

Write-Host "Setting up SynQuest environment..." -ForegroundColor Cyan
...
Write-Host "   Run with: python main.py" -ForegroundColor Gray
